...
Ten en cuenta que si el reno **recoge algo del suelo**, ya es `'success'`, independientemente de si en movimientos posteriores se chocase con un obstáculo o saliese del tablero.
